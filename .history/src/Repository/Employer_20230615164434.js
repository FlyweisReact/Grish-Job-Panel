...
export const AddJob = async (employer , jobtitle , jobtype , vehicletype , gender , description , contactNumber , location , address , postalCode , image , salaryOffertotalExperience) => {
    try {
      const response = await axios.post(`${BaseUrl}api/v1/employ`, {
        employer,
      });

...
import { AddVehicleType, DeleteVehicleType } from "../../Repository/Employer";
        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" onChange={(e) => UploadImages(e)} />
            </Form.Group>
            ...
            <FloatingLabel
              ...
              className="mb-3"
            >
              <Form.Control as="textarea" onChange={(e) => setMe} />
            </FloatingLabel>

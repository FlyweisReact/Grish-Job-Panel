...
import { AddJob, AllJobs, DeleteJobs, GetAllEmployer } from "../../Repository/Employer";
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <Form.Select aria-label="Default select example" className="mb-3" onChange={(e) => setEmployer(e.target.value)}>

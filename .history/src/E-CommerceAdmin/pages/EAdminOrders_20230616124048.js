...
const EAdminOrders = () => {
  ...
  function EditStatus(props) {
    ...
    const postHandler = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.post("https://gadi-driver-u8ym.vercel.app/api/v1/vedioo" , {
      ...
      >
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type='text' onChange={(e) => setStartTime(e.target.value)} />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>End Time</Form.Label>
            <Form.Control type='text' onChange={(e) => setEndTime(e.target.value)} />
          </Form.Group>
